  ...
  return (
      ...
      <div className="max-w-4xl w-full bg-white p-8 border border-gray-300 rounded-lg shadow-md">
        <div className="flex justify-center">
          <img src={logo} alt="Company Logo" className="mb-4 w-48" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-6">
            <div className="relative w-full min-w-[200px] h-14">
              <input
                type="text" value={firstName} // Changed from text to password
            ...
            <div className="relative w-full min-w-[200px] h-14">
              <input
                type="email" value={email}// Changed from text to password
                className="peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 border focus:border-2 border-t-transparent focus:border-t-transparent text-sm px-3 py-2.5 rounded-[7px] border-blue-gray-200 focus:border-[#fe5c84]"
                placeholder=" "
          ...
          <div className="space-y-6">
            <div className="relative w-full min-w-[200px] h-14">
              <input
                type="text" value={lastName}// Changed from text to password
                className="peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 border focus:border-2 border-t-transparent focus:border-t-transparent text-sm px-3 py-2.5 rounded-[7px] border-blue-gray-200 focus:border-[#fe5c84]"
                placeholder=" "
            ...
            <div className="relative w-full min-w-[200px] h-14">
              <input
                type="number" // Changed from text to password
                className="peer w-full h-full bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 border focus:border-2 border-t-transparent focus:border-t-transparent text-sm px-3 py-2.5 rounded-[7px] border-blue-gray-200 focus:border-[#fe5c84]"
          ...
          <div className="col-span-2">
            <button
              type="submit"
              className="w-1/4 h-9 flex justify-center items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#fe5c84] hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
            >Create Account
            </button>
          </div>
        </form>
